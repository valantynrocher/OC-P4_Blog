...
<div class="container-fluid">
	...
	<div class="row">
        <div class="card col container align-self-center">
            ...
            <form action="admin.php?url=users&action=updateAccount&userId=<?=$_SESSION['user']['id']?>" method="POST">
                <div class="form-row">
    ...
    <div class="row">
        <div class="card col container align-self-center">
            ...
            <form action="admin.php?url=users&action=updatePass&userId=<?=$_SESSION['user']['id']?>" method="POST" class="form-signin">
                ...
                <input class="btn btn-warning" name="submit" type="submit" value="Enregistrer"></input>
            </form>
